...
export const Lieu = ({
  ...
  if (nom === 'Recup Verre') {
    image = (
      <section className={iconStyle.verreContainer}>
        <button className={iconStyle.verreBackground}>
          <GiBrokenBottle className={iconStyle.button} />
        </button>
      </section>
    );
  }
  if (categorie === 'Bornes à compost') {
    image = (
      <section className={iconStyle.decheterieContainer}>
        <button className={iconStyle.decheterieBackground}>
          <RiPlantFill className={iconStyle.button} />
        </button>
      </section>
    );
  }
  if (categorie === 'Collecte vetements') {
    image = (
      <section className={iconStyle.vetementContainer}>
        <button className={iconStyle.vetementBackground}>
          <FaTshirt className={iconStyle.button} />
        </button>
      </section>
    );
  }
  if (categorie.startsWith('D')) {
    image = (
      <section className={iconStyle.compostContainer}>
        <button className={iconStyle.compostBackground}>
          <FaTrash className={iconStyle.button} />
        </button>
      </section>
    );
  }
  ...
  return (
    <>
      <div
        className={style.lieu}
        key={voie}
        onClick={() => markersRef.current[id].fire('click') && scrollToTop()}
      >
